    ...
    element: (() => {
        ...
        if (193 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map shows the main input and output layers, along with a few clear matching examples. For all intermediate steps and full geoprocessing details, refer to the accompanying QGIS project.';
            }
