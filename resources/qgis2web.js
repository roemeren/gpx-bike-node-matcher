...
map.getView().fit([496120.017308, 6530022.805199, 600039.790396, 6606660.617045], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">QGIS Demo for GPX Bike Node Matcher</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (257 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map shows the key input layers and the main steps of the matching process, including intersections, segment match status, and the final matched routes. For all intermediate steps and full geoprocessing logic, refer to the accompanying QGIS project.';
            }
